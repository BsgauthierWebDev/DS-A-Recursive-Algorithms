...
//   (can't be the original rod where it was stacked before) where it will be stacked in the 
...
//          Solution: n = disks, 2^n-1
//     Implement your algorithm using recursion. Your program should display each movement 
//     of the disk from one rod to another.
//     If you are given 5 disks, how do the rods look like after 7 recursive calls?
//          Solution: 
//     How many moves are needed to complete the puzzle with 3 disks? with 4 disks? with 5 disks?
//          Solution: 7, 15, 31
//     What is the runtime of your algorithm?
//          Solution: Polynomial: O(n^k)
